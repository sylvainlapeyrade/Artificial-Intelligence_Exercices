...
/**
 * Priority queue. Objects stored in a priority queue must implement the
...
public class PriorityQueue {
    ...
    /**
     * Put an object on the queue. Returns FALSE if object already there
     * 
    ...
    public synchronized boolean put(Prioritized x) {
        ...
        while (it.hasNext()) {
            ...
            /*
             * if (x.getPriority() == p.getPriority()) { Random r = new Random(); if
             * (r.nextBoolean()) { q.add(index, x); return true; } }
             */
            index++;
        }
        q.add(index, x);
    ...
    /**
     * Rebuild priority queue in case the priorities of its elements have changed
     * since they were inserted. If the priority of any element changes, this method
     * must be called to update the priority queue.
     */
    /*
     ...
     * Iterator it = q.listIterator();
     * 
     * for (int i = (q.size() / 2) - 1; i >= 0; --i) heapify(i); }
     */
    /*******************************************************************************
     *******************************************************************************
    ...
    /*
     * Return the priority of the element at position i. For convenience, positions
     * beyond the end of the table have infinite priority.
     */
