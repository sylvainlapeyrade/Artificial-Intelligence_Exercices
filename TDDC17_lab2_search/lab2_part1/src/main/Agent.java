...
public class Agent {
    ...
    /*******************************************************************************
     *******************************************************************************
     ** selectTarget This function selects the closest dirt
     ** 
    ...
    /*******************************************************************************
     *******************************************************************************
     ** stepToTarget Makes one step in the world towards the destination The agent
     * plans within its own world (m_World) but executes in the real world
     ** 
    ...
    /*******************************************************************************
     *******************************************************************************
     ** searchPlan This function returns a plan from the start node to the goal node
     * as an arry list. The method for planning can be defined by method.
     ** 
    ...
    public SearchObject searchPlan(World world, GridPos start, GridPos goal, int method, boolean printResult) {
        ...
        case BREADTH_FIRST_SEARCH: {
            ...
            time -= (new Date()).getTime();
            if (printResult)
                System.out.println("\tNeeded " + (-time) + " msec, PathLength:  " + breadthPlan.size()
                        + ", NumExpNodes: " + myProblem.getNumExpandedNodes());
        ...
        case ASTAR_SEARCH: {
            ...
            time -= (new Date()).getTime();
            if (printResult)
                System.out.println("\tNeeded " + (-time) + " msec , PathLength: " + astarPlan.size() + ", NumExpNodes: "
